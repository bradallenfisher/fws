...
cat /var/www/html/fws/scripts/local.vhost.txt > /etc/apache2/sites-available/$site.conf
  ...
  for site in *
    do
      ...
      then
        ...
        echo "\$sites['www.${site}.co'] = '${site}';"   >> /var/www/html/fws/docroot/sites/sites.php
        echo "\$sites['${site}.co'] = '${site}';"   >> /var/www/html/fws/docroot/sites/sites.php
        echo "\$sites['www.${site}.org'] = '${site}';"   >> /var/www/html/fws/docroot/sites/sites.php
        echo "\$sites['${site}.org'] = '${site}';"   >> /var/www/html/fws/docroot/sites/sites.php
